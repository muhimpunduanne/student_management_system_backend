...
${er(e)}`}function Gn(e){return`We would appreciate if you could take the time to share some information with us.
...
We detected that you are using Next.js, learn how to fix this: https://pris.ly/d/engine-not-found-nextjs.`:""}function ml(e){let{queryEngineName:r}=e;return`${Xe(e)}${Qn(e)}
...
${er(e)}`}function gl(e){let{queryEngineName:r}=e;return`${Xe(e)}${Qn(e)}
